    ...
    const onkeyp=async (e)=>{
       if(e.code=="Enter" && !!username){
        try {
            ...
            const q=query(userRef,or(where("displayName","==",username),where("email","==",username)));
    ...
    <div className="shrink-0">
        <div className="relative">
            ...
            <input 
               ...
               value={username}
               autoFocus
               className="w-full h-12 rounded-xl bg-c1/[0.5] pl-11 pr-16 placeholder:text-c3 outline-none
               text-base"
               />
        ...
        {user && (<>
            <div className="mt-5 flex items-center gap-4 rounded-xl hover:bg-c5 py-2 px-4
                cursor-pointer" onClick={()=>handleSelect(user)}
                >
                  <Avatar size="large"
                  user={user} />
